...
class Model(nn.Module):
    def __init__(self):
        ...
        self.DIM_I = 3 * 3 * 11
        self.DIM_O = 1
        chw0, chw3, chw4, chw5 = 64, 256, 420, 256
        chres = 128
        ...
        self.conv3 = nn.Conv2d(
            in_channels=chw0 + chw0, out_channels=chw3, kernel_size=2
        )
    ...
    def forward(self, x: torch.Tensor):
        ...
        # Concatenate output2 and output0
        output2all = torch.cat((output2, output0), dim=1)
